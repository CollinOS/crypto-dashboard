                ...
                .map((trade) => (
                  <div key={trade.id} trade={trade} className="">
                    <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 sm:gap-4 px-1 py-1 border-t border-dark-border">
                      ...
                      <p className={trade.buy == true ? 'text-sm text-green text-right sm:hidden' : 'text-sm text-red text-right sm:hidden'}>
                        $
                        {trade.coin_price_usd.toLocaleString()}
                      </p>
                      <p className="text-sm text-primary text-right hidden sm:table-cell">
                        $
                        {trade.coin_price_usd.toLocaleString()}
                      </p>
